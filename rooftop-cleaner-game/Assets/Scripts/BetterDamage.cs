...
public class BetterDamage : MonoBehaviour {
	...
	{	
		if (damageOnCollision) {
			...
			if (collision.gameObject.GetComponent<BetterHealth> () != null) {	// if the hit object has the Health script on it, deal damage
				collision.gameObject.GetComponent<BetterHealth> ().ApplyDamage (damageAmount);
